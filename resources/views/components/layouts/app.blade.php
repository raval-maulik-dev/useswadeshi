            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    ...
                    <div class="flex space-x-4">
                        <a href="http://instagram.com/use.swadeshi/" target="_blank"
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                <p class="text-gray-300 text-sm">{{ __('messages.company_name') }}</p>
                                <p class="text-gray-300 text-sm">{{ __('messages.company_address') }}</p>
                            </div>
                        </div>
